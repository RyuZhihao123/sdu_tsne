...
if __name__ == "__main__":
    ...
    anchor_points = select_anchor_point(match_points, rate = 0.0)

    ''' first we apply t-sne to D0 '''
    Y0, Y_1_I = tsne(X = X0, no_dims = 2, initial_dims = 3, perplexity = 20.0)
    ''' then we apply joint-tsne to D1 '''
    Y1 = joint_tsne(Y_0 = Y0, Y_1_I = Y_1_I, X_1 = X1, match_points = anchor_points, match_edges=match_edges, no_dims = 2, initial_dims_1 = 3, perplexity = 20.0)
